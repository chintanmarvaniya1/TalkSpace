  ...
  return (
    <div className='fixed top-0 bottom-0 left-0 right-0 bg-gray-700 bg-opacity-40 flex justify-center items-center z-10'>
      <div className='bg-white p-4 py-6 m-1 rounded w-full max-w-sm'>
        <h2 className='font-semibold text-center'>Edit user details</h2>


        <form className='grid gap-3 mt-3' onSubmit={handleSubmit}>

          <InputField label="Name" type="text" name='name' placeholder="Enter Name"
            value={data.name} handleOnChange={handleOnChange} className='w-full py-1 px-2 focus:outline-primary border-0.5' />
